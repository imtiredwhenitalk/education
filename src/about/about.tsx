	...
	return (
		<section className="rounded-2xl border border-slate-300 bg-white/80 p-5 shadow-panel">
			...
			<p className="mt-3 text-sm leading-6 text-slate-700">
				...
				статистику, працювати з електронним щоденником і персональним кабінетом.
			</p>
			...
			<div className="mt-4 grid gap-3 md:grid-cols-2">
				<div className="rounded-xl border border-slate-300 bg-white p-3">
					...
					<p className="mt-1 text-sm text-slate-600">
						...
						адмін-панель і модулі оцінювання.
					</p>
				</div>
				<div className="rounded-xl border border-slate-300 bg-white p-3">
					<h3 className="font-semibold text-slate-900">Для кого</h3>
					<p className="mt-1 text-sm text-slate-600">
						Учні бачать щоденник і свої оцінки, вчителі додають оцінки та новини, адміністрація
						керує користувачами й контролює інформаційні розділи.
					</p>
				</div>
			</div>
		</section>
